...
\begin{subfigure}[t]{0.64\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/ppc_two_a30.pdf}  % 图1路径
  \caption{{\small ECDFs}}
  \label{fig:ecdf-event_a30}
\end{subfigure}
\begin{subfigure}[t]{0.35\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/fake_duration_hist_a30.pdf}   % 图3路径
...
\begin{subfigure}[t]{0.64\textwidth}
  \centering
  \includegraphics[width=\textwidth]{images/ppc_two_a1000.pdf}  % 图1路径
  \caption{{\small ECDFs}}
  \label{fig:ecdf-event_a1000}
\end{subfigure}
\begin{subfigure}[t]{0.35\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/fake_duration_hist_a1000.pdf}   % 图3路径
  \caption{{\small Fake-data histogram}}
