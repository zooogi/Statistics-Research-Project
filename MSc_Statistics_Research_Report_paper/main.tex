...
\usepackage{tcolorbox}            % nice framed boxes
...
%\declarationdate{DATE}if you choose to use footnotes, do so sparingly.
\declaration 
...
\input{MSc_Statistics_Research_Report_paper/section/Implement}
\section{Results}
